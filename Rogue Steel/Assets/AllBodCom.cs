...
public class AllBodCom : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        for (int i = 0; i < width; i++)
        {
            for (int n = 0; n < length; n++)
            {
                ...
                //Modules.GetComponent<ModulePart>().PartDetail(innards[i, n], component.GetComponent<ModuleInfo>().Model);
                component.GetComponent<ModuleInfo>().setValues(component.GetComponent<ModuleInfo>().MaxHp, component.GetComponent<ModuleInfo>().MaxArmor, component.GetComponent<ModuleInfo>().MaxDur);
    ...
    public void com(string inp)
    {
        ...
        {
            case "am":
                modulesData.GetComponent<ModulesData>().UpdateINfo(Ammunition, FuelTank);
                componentTemp = Ammunition;

                break;
            case "en":
                modulesData.GetComponent<ModulesData>().UpdateINfo(Engine, FuelTank);
                componentTemp = Engine;
                break;
            case "fu":
                modulesData.GetComponent<ModulesData>().UpdateINfo(Fuel, FuelTank);
                componentTemp = Fuel;
                break;
            case "hd":
                modulesData.GetComponent<ModulesData>().UpdateINfo(HorizontalDrive, FuelTank);
                componentTemp = HorizontalDrive;
                break;
            case "ra":
                modulesData.GetComponent<ModulesData>().UpdateINfo(Radiator, FuelTank);
                componentTemp = Radiator;
                break;
            case "cd":
                modulesData.GetComponent<ModulesData>().UpdateINfo(Driver, FuelTank);
                componentTemp = Driver;
                break;
            case "cg":
                modulesData.GetComponent<ModulesData>().UpdateINfo(Gunner, FuelTank);
                componentTemp = Gunner;
                break;
            case "cl":
                modulesData.GetComponent<ModulesData>().UpdateINfo(Loader, FuelTank);
                componentTemp = Loader;
                break;
            default:
                modulesData.GetComponent<ModulesData>().UpdateINfo(ArmorBlock, FuelTank);
